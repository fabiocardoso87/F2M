...
import br.com.softdesign.f2m.Framework.Interfaces.ITextField;
...
public class TextField implements ITextField {
    ...
    public boolean hasText(String searchStr) {
        return this.getText().trim().equalsIgnoreCase(searchStr.trim());
    }
